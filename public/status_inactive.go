...
var STATUS_INACTIVE string = `<!DOCTYPE html>"
<html lang="en">
  <head>
    <meta charset="UTF-8" />
  ...
  <body>
    <div class="container">
      ...
      <h1 class="main-heading">Oops! Routing deactivated!</h1>
      <h2 class="sub-heading">
        Routing has been deactivated for this domain.
      </h2>
      <p class="info-text">
        If you are the user of this site, please contact site owner and if you are the site owner please contact your internal team.
      </p>
